...
# DONE: USE A LIST COMPREHENSION TO CREATE A LIST OF ALL OF THE FULL_NAMES
# in lowercase format
lowercase_full_names = [full_name for full_name in full_names]
print(lowercase_full_names)
almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']
# DONE: USE A LIST COMPREHENSION TO CREATE A LIST OF INTEGERS
# from the above list of strings
numbers = [ int(almost_number) for almost_number in almost_numbers]
print(numbers)
# DONE: USE A LIST COMPREHENSION TO CREATE A LIST OF ONLY THE NUMBERS THAT ARE
numbers = [number for number in numbers if number > 9]
print(numbers)
# DONE: GREATER THAN 9 FROM THE NUMBERS (NOT STRINGS) YOU JUST CREATED