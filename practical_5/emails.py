...
email = input("Email: ")
while email != '':  # DONE: ASK THE USER FOR THEIR EMAIL UNTIL THEY ENTER A BLANK ONE.
    parts = email.split("@", 1)
    ...
    email = input("Email: ")    # DONE: JUST LOOP THROUGH THE DICTIONARY (USE THE ITEMS METHOD) AND PRINT THEM OUT.
